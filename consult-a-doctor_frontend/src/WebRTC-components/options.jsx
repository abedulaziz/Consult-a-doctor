        ...
        {callAccepted && !callEnded ? (
          <>
            <div className="option_buttons">
              <div ref={videoButton} className="video_status" data-type="video" onClick={(ev) => changeMyStreamSet(ev)}>
                {video}
              </div>

              <div ref={audioButton} className="mic_status" data-type="audio" onClick={(ev) => changeMyStreamSet(ev)}>
                {mic}
              </div>

              <div className="call_status" onClick={leaveCall}>
                <PhoneOff />
              </div>
            </div>
          </>
